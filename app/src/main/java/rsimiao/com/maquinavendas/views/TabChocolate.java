...
import rsimiao.com.maquinavendas.helpers.ChocolateHelper;
 ...
 */
public class TabChocolate extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new ProdutoAdapter(ChocolateHelper.getDataSet(),statusMaquina);
