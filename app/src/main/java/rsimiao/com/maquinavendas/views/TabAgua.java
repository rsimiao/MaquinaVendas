...
import rsimiao.com.maquinavendas.helpers.AguaHelper;
 ...
 */
public class TabAgua extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new ProdutoAdapter(AguaHelper.getDataSet(), statusMaquina);
